import { CheckCircle2, Circle, Droplets, Dumbbell, Footprints, Utensils } from "lucide-react";
...
/** Kompakte Status-Pills für den heutigen Tag (Training/Essen/Wasser/Schritte). */
export function MemberStatusPills({ status }: Props) {
  const signals = [
